...
add_vehicle_mobile_bp = Blueprint('add_vehicle_mobile', __name__, url_prefix='/api/add_vehicle_mobile')
...
@add_vehicle_mobile_bp.route('/', methods=['GET'])
...
@add_vehicle_mobile_bp.route('/<int:id_add_vehicle>', methods=['GET'])
...
@add_vehicle_mobile_bp.route('/area/<int:id_area>', methods=['GET'])
...
@add_vehicle_mobile_bp.route('/', methods=['POST'])
...
@add_vehicle_mobile_bp.route('/<int:id_add_vehicle>', methods=['PUT'])
...
@add_vehicle_mobile_bp.route('/<int:id_add_vehicle>', methods=['DELETE'])
